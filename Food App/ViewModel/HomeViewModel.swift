    ...
    func fetchData(){
        ...
        db.collection("Items").getDocuments { (snap, err) in
            ...
            self.items = itemData.documents.compactMap({ (doc) -> Item? in
                ...
                return Item(id: id, item_name: name, item_cost: cost, item_details: "In this collection of tasty collection of air-fried pork chop recipes, you'll learn how to cook boneless pork chops in the air fryer so they stay succulent and juicy.", item_image: image, item_ratings: ratings)
            })
